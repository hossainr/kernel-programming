...
static int __init mychardev_init(void)
{
    ...
    dev_t dev;
    /* 
       allocate a range device number, allocate device major 
       number dynamically and returned along with first minor 
       number in dev_t 
    */
    ...
    for (i = 0; i < MAX_DEV; i++) {
        ...
        /* create a device node in /dev/ and register with sysfs */
